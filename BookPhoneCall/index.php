...
<!--                </fb:login-button>-->
    ...
    <div id="home-content-inner" class="home-step-4">
      <div class="prev-steps-wrapper">
        ...
        <div class="step-2-prev-btn"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/prev-btn-green-tick.png" width="21" height="21"> STEP 2: ENQUIRY TYPE</div>
        <div class="step-3-prev-btn"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/prev-btn-green-tick.png" width="21" height="21"> STEP 3: CHOOSE METHOD (LOGGED INTO BOOKPHONECALL>COM ACCOUNT) or CHOOSE METHOD (NEW CALL BACK REQUEST)</div>
      </div>
