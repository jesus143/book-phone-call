...
if (isset ($_POST['bookphonecallsubmit'])) 
{
    ...
    function bpcinsertcustomer( $title, $firstname, $lastname, $email, $fbemail, $dateofbirth, $gender, $contact1, $contact2, $contact3 ) 
    {
        global $wpdb;
...
bpcinsertcustomer( $title, $firstname, $lastname, $email, $fbemail, $dateofbirth, $gender, $contact1, $contact2, $contact3 );


    //add to database bpcbooking
