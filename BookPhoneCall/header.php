...
<div id="primary-nav" style="width: 1064px; margin: 0px auto; padding: 0px; font-size: 10px; background-color: rgb(70, 70, 70);">
...
<div id="header">
  <div id="inner-wrapper">
    <div id="header-banner">
      <div class="hb-1"> <img src="http://bookphonecall.com/wp-content/uploads/2017/01/phone-icon.png" alt="icon" width="100" height="100"> </div>
      <div class="hb-2">
      ...
      <div class="hb-3">
        ...
        <a href="#"><img src="http://bookphonecall.com/wp-content/uploads/2017/01/header-vid1.png" alt="video" width="143" height="82"></a> </div>
    </div>
